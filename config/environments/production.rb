Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "ph-airbnb-rails-johnedel_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'https://airbnbcloneapp.herokuapp.com/' }
